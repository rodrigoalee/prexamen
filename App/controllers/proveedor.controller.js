...
exports.create = (req, res) => {
    ...
    try {
        // Asignar valores del cuerpo de la solicitud al objeto proveedor
...
exports.retrieveAllProveedores = (req, res) => {
    Proveedor.findAll()
        .then(proveedorInfos => {
            res.status(200).json({
                message: "Información de todos los proveedores obtenida exitosamente",
